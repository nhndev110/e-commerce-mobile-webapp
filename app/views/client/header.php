<header class="container-fluid">
  <nav class="nav-header container">
    <a href="./index.php" class="logo-header">
      <img class="img-logo" src="./public/client/images/logo.png" alt="nhndev110 - Điện thoại, laptop, tablet, phụ kiện chính hãng" title="nhndev110 - Điện thoại, laptop, tablet, phụ kiện chính hãng">
    </a>
    <ul class="nav nav-left">
      <li><a class="set-home" href="./index.php">Trang Chủ</a></li>
      <li><a class="set-intro" href="#!">Giới Thiệu</a></li>
      <li><a class="set-products" href="/products">Sản Phẩm</a></li>
    ...
    <ul class="nav nav-right">
      <?php if (empty($_SESSION['name']) || empty($_SESSION['id'])) { ?>
        <li class="section-guest">
          ...
          <?php require_once './app/views/client/signin.php' ?>
        </li>
        <li class="section-guest">
          ...
          <?php require_once './app/client/signup.php' ?>
        </li>
      <?php } else { ?>
        <li>
